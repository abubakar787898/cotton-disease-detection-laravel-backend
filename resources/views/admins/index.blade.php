          ...
          <tr>
              ...
              <td>
                  ...
                  <form action="{{ route('admins.destroy',$user->id) }}" method="POST">
                      <a class="btn btn-info" href="{{ route('admins.show',$user->id) }}">  <i class="bi bi-eye-fill"></i></a>
                    
                      <a class="btn btn-primary" href="{{ route('admins.edit',$user->id) }}"> <i class="bi bi-pencil-square"></i></a>
